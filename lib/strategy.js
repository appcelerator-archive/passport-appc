...
function Strategy(options, verify) {
	...
	this._appcURL = options.appcURL || 'https://dashboard.appcelerator.com/?redirect={callbackURL}';
}
...
Strategy.prototype.authenticate = function (req, options) {
	...
	// we're not to process the SID unless we're on our callback URL
	if (requireCallbackURL && callbackURL && callbackURL !== currentURL) {
